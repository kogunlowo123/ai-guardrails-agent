"""AI Guardrails Agent - Main Agent Implementation."""
...
class AiGuardrailsAgentAgent:
    ...
    def __init__(self):
        ...
        self.output_filtering_enabled = True
        self.pii_detection_enabled = True
        self.toxicity_screening_enabled = True
        self.jailbreak_prevention_enabled = True
        self._tool_dispatch = {
            "validate_input": self.tools.validate_input,
            "filter_output": self.tools.filter_output,
            "detect_pii": self.tools.detect_pii,
            "screen_toxicity": self.tools.screen_toxicity,
            "detect_jailbreak": self.tools.detect_jailbreak,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['input_validation', 'output_filtering', 'pii_detection', 'toxicity_screening', 'jailbreak_prevention'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "screen_toxicity": ['screen', 'toxicity'],
