"""AI Guardrails Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="AI safety guardrails agent that implements input/output validation, content filtering, topic restriction, PII detection, toxicity screening, and jailbreak prevention for production LLM applications.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
